  ...
  public render(): React.JSX.Element {
    return (
      <Stack direction={'column'}>
        ...
        {this.mappings.map((mapping, i) => <SVGMappingItem key={mapping.svgId + mapping.mappedName} value={{ svgId: mapping.svgId, mappedName: mapping.mappedName }} onChange={(mapping) => this.onChange(i, mapping)} onDelete={() => this.onDelete(i)} />)}
      </Stack>
    );
  }
}
